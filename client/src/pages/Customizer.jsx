...
import {AIPicker, ColorPicker, CustomButton, FilePicker, Tab} from "../components/index"
      ...
      {!snap.intro && (
        <>
          ...
          <motion.div className="absolute z-10 top-5 right-5" {...fadeAnimation}>
            <CustomButton type="filled" title="Go Back" handleClick={() => state.intro = true} customStyles="w-fit px-4 py-5 font-bold text-sm" />
          </motion.div>
